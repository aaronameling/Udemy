...
class Haushaltsbuch {
    ...
    eintrag_hinzufuegen(formulardaten) {
        ...
        this._monatslistensammlung.aktualisieren(this._eintraege); // unterstrich fehlt
    ...
    eintrag_entfernen(timestamp) {
        ...
        this._monatslistensammlung.aktualisieren(this._eintraege); // unterstrich fehlt / oder ohne funktionsaufruf, oder
                                                                   // aktualisieren muss noch als eine neue methode hinzugefügt werden
        this._gesamtbilanz.aktualisieren(this._eintraege);
    }
