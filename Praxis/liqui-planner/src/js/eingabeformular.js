...
const eingabeformular = {
    ...
    datum_aktualisieren(e) {
        let datums_input = document.querySelector("#datums");
    ...
    html_fehlerbox_generieren(formular_fehler) {
        ...
        fehlertext.textContent = "Es gibt einen Fehler in folgenden Eingabefeldern:";
        ...
        eingabeformular.innerHTML = `
            ...
            <div class="eingabeformular-zeile">
                <div class="betrag-datum-eingabe-gruppe">
                    ...
                    <input type="number" id="betrag" name="betrag" form="eingabeformular" placeholder="z.B. 10,42" size="10" step="0.01" 
